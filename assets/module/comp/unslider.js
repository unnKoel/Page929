...
define(function (require) {
    ...
    return function () {
        ...
        this.setup = function () {
            ...
            if (this.opts.arrows) {
                this.el.append('<a class="left carousel-control prev" role="button" data-slide="prev"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><span class="sr-only">Previous</span> </a><a class="right carousel-control next" role="button" data-slide="next"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><span class="sr-only">Next</span></a>').find("a").click(function () {
                    if (e(this).hasClass('prev')) {
                        e.isFunction(n['prev']) && n['prev']();
                    } else {
                        e.isFunction(n['next']) && n['next']();
                    }
                })
            }
            if (e.event.swipe) {
